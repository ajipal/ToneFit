...
export default function ComparePage() {
  ...
  return (
    <div className="min-h-screen bg-white text-black">
      ...
      <div className="px-14 py-10 max-w-7xl mx-auto flex flex-col gap-8">

        {/* Header */}
        <div className="flex items-end justify-between">
          <div>
            <p className="text-xs font-bold tracking-widest uppercase text-neutral-400 mb-2">Model Comparison</p>
            <h1 className="text-[40px] font-black leading-tight tracking-tight">FaRL vs SVM</h1>
          ...
          {result && (
            <button onClick={reset} className="text-sm font-semibold text-neutral-500 underline underline-offset-2 hover:text-black transition-colors">
              Try another photo
            </button>
          )}
        </div>
        ...
        {error && (
          error === "no_face" ? (
            <div className="rounded-2xl bg-neutral-50 border border-black/8 p-6 max-w-sm flex flex-col gap-3">
